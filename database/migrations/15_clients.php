...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('clients', function (Blueprint $table) {
            ...
            $table->string('email_address')->unique('clients_email_address_unique');
            $table->string('home_address', 255);
            $table->string('curr_address', 255);
            $table->string('id_number')->unique('clients_id_number_unique');
            $table->foreignId('program_id')->constrained('degree_programs')->onDelete('cascade')->onUpdate('cascade');
