        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <div class="flex sm:flex-row flex-col">
                    ...
                    <TextInput id="middle_name" v-model="form.middle_name" type="text" class="mt-1 mr-1 block w-full"
                        autocomplete="middle_name" />
                    <InputError :message="form.errors.middle_name" class="mt-2" />
                    <TextInput id="last_name" v-model="form.last_name" type="text" class="mt-1 mr-1 block w-full"
