        ...
        <template #formBody>
            <div class="grid grid-cols-1">
                ...
                <div class="grid grid-cols-4">
                    <InputText v-model.number="form.height" label="Height (cm)" required type="number" :errorMsg="form.errors.height" @input="onFocusClearError('height');" />
                    <InputText v-model.number="form.weight" label="Weight (kg)" required type="number" :errorMsg="form.errors.weight" @input="onFocusClearError('weight');" />
                    <InputText v-model.number="form.blood_pressure" label="Blood Pressure" required :errorMsg="form.errors.blood_pressure" @input="onFocusClearError('blood_pressure');" />
                    <InputText v-model.number="form.pulse" label="Pulse Rate" required :errorMsg="form.errors.pulse" @input="onFocusClearError('pulse');" />
                </div>
                <div class="grid grid-cols-4">
