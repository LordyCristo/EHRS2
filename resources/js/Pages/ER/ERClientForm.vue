            ...
            <div class="grid grid-cols-1">
                ...
                <div class="flex items-center justify-start my-3">
                    <div class="flex items-center">
                        <input type="checkbox" v-model="form.is_emergency" :checked="form.is_emergency" @click="emergencyChange" class="rounded-full border-red-700 active:bg-red-700 checked:bg-red-700">
