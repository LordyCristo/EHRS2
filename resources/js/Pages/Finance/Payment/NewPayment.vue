        ...
        <div class="flex justify-center items-center h-full w-full">
            <div class="max-w-5xl sm:p-5 p-1 bg-gray-100 rounded-sm w-1/2">
                <div class="flex items-center justify-between mb-3 gap-2">
                    ...
                    <h1 class=" text-center w-fit text-xl font-semibold">New Transaction Record</h1>
                    <Link :href="route('finance.payment.index')" class="text-gray-600 hover:text-gray-900 duration-300">
                        <CloseIcon class="w-6 h-auto hover:rotate-90 duration-300" />
                    </Link>
                </div>
                <h2>{{ this.$page.props.last_payment_id }}</h2>
...
import PaymentForm from "@/Pages/Finance/Payment/PaymentForm.vue";
</script>
<script>
export default {
    data: () => ({
